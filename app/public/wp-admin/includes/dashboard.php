...
function wp_dashboard_recent_drafts( $drafts = false ) {
	if ( ! $drafts ) {
		 ...
		 */
		$args = apply_filters( 'dashboard_recent_drafts_query_args', $args );
...
function wp_dashboard_recent_posts( $args ) {
	 ...
	 * @since 4.2.0
	 *
	 * @param array $args The arguments passed to WP_Query to produce the list of posts.
	 */
	$args = apply_filters( 'dashboard_recent_posts_query_args', $args );
