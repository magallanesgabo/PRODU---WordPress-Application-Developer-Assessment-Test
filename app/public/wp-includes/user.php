...
function wp_list_users( $args = array() ) {
	...
	$args           = wp_array_slice_assoc( $parsed_args, array( 'orderby', 'order', 'number', 'exclude', 'include' ) );
	$args['fields'] = 'ids';
	 ...
	 */
	$args = apply_filters( 'wp_list_users_args', $args, $parsed_args );
...
function wp_dropdown_users( $args = '' ) {
	 ...
	 */
	$args = apply_filters( 'wp_dropdown_users_args', $args, $parsed_args );
